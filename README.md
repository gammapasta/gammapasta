...
| **[자체 개발한 로봇팔과 그리터를 탑재한 층간이동 자율주행 로봇](https://github.com/gammapasta/Scorpy)** | 하드웨어부터 소프트웨어까지 직접 개발한 로봇팔, 그리퍼와 로봇으로 층간 이동 시스템 구현 | Python, Raspberry Pi, STM32, YOLO, Autodesk Fusion, EasyEDA |
