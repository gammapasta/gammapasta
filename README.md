...
| **[ROS2 기반 지능형 협업 폭발물 해체 로봇 시스템](https://github.com/gammapasta/*)** | LiDAR, SLAM 기반 순찰 로봇 구현, YOLO 기반 폭발물 탐지 및 모방학습 구현, 연산 부하 분산을 위한 다중 PC 기반 분산 서버 아키텍처 설계, ROS 도메인 분리와 브릿지로 로봇 동시 운용 | ROS2, SLAM, Imitation learning, C, Python, Raspberry Pi, YOLO |
---
